...
class DigitalTwin:
    ...
    def building_loader(self):
        ...
        data_dict = {"Building_1":{"Heat_Pump":{"nominal_power": self.E_hpC_max[0], "technical_efficiency":self.eta_hp_tech, "t_target_heating":45 ,"t_target_cooling":self.t_hp_C},
               "Electric_Water_Heater":{"nominal_power":self.E_ehH_max[0], "efficiency":self.eta_ehH},
               "Chilled_Water_Tank":{"capacity":self.C_p_Csto[0], "loss_coefficient":self.C_f_Csto},
               "DHW_Tank":{"capacity":self.C_p_Hsto[0], "loss_coefficient":self.C_f_Csto},
			   "Battery":{"capacity":self.C_p_bat[0],"efficiency":self.eta_bat[0],"capacity_loss_coefficient":self.C_f_bat,"loss_coefficient":0,"nominal_power":self.E_bat_max[0],"power_efficiency_curve":[[0,1],[1,1]],"capacity_power_curve":[[0,1],[1,1]]}
              },
         
       "Building_2":{"Heat_Pump":{"nominal_power": self.E_hpC_max[1], "technical_efficiency":self.eta_hp_tech, "t_target_heating":45 ,"t_target_cooling":self.t_hp_C},
               "Electric_Water_Heater":{"nominal_power":self.E_ehH_max[1], "efficiency":self.eta_ehH},
               "Chilled_Water_Tank":{"capacity":self.C_p_Csto[1], "loss_coefficient":self.C_f_Csto},
               "DHW_Tank":{"capacity":self.C_p_Hsto[1], "loss_coefficient":self.C_f_Csto},
			   "Battery":{"capacity":self.C_p_bat[1],"efficiency":self.eta_bat[1],"capacity_loss_coefficient":self.C_f_bat,"loss_coefficient":0,"nominal_power":self.E_bat_max[1],"power_efficiency_curve":[[0,1],[1,1]],"capacity_power_curve":[[0,1],[1,1]]}
              },
         
         "Building_3":{"Heat_Pump":{"nominal_power": self.E_hpC_max[3], "technical_efficiency":self.eta_hp_tech, "t_target_heating":45 ,"t_target_cooling":self.t_hp_C},
               "Electric_Water_Heater":{"nominal_power":self.E_ehH_max[2], "efficiency":self.eta_ehH},
               "Chilled_Water_Tank":{"capacity":self.C_p_Csto[2], "loss_coefficient":self.C_f_Csto},
               "DHW_Tank":{"capacity":self.C_p_Hsto[2], "loss_coefficient":self.C_f_Csto},
			   "Battery":{"capacity":self.C_p_bat[2],"efficiency":self.eta_bat[2],"capacity_loss_coefficient":self.C_f_bat,"loss_coefficient":0,"nominal_power":self.E_bat_max[2],"power_efficiency_curve":[[0,1],[1,1]],"capacity_power_curve":[[0,1],[1,1]]}
              },
         
         "Building_4":{"Heat_Pump":{"nominal_power": self.E_hpC_max[3], "technical_efficiency":self.eta_hp_tech, "t_target_heating":45 ,"t_target_cooling":self.t_hp_C},
               "Electric_Water_Heater":{"nominal_power":self.E_ehH_max[3], "efficiency":self.eta_ehH},
               "Chilled_Water_Tank":{"capacity":self.C_p_Csto[3], "loss_coefficient":self.C_f_Csto},
               "DHW_Tank":{"capacity":self.C_p_Hsto[3], "loss_coefficient":self.C_f_Csto},
			   "Battery":{"capacity":self.C_p_bat[3],"efficiency":self.eta_bat[3],"capacity_loss_coefficient":self.C_f_bat,"loss_coefficient":0,"nominal_power":self.E_bat_max[3],"power_efficiency_curve":[[0,1],[1,1]],"capacity_power_curve":[[0,1],[1,1]]}
              },
         
         "Building_5":{"Heat_Pump":{"nominal_power": self.E_hpC_max[4], "technical_efficiency":self.eta_hp_tech, "t_target_heating":45 ,"t_target_cooling":self.t_hp_C},
               "Electric_Water_Heater":{"nominal_power":self.E_ehH_max[4], "efficiency":self.eta_ehH},
               "Chilled_Water_Tank":{"capacity":self.C_p_Csto[4], "loss_coefficient":self.C_f_Csto},
               "DHW_Tank":{"capacity":self.C_p_Hsto[4], "loss_coefficient":self.C_f_Csto},
			   "Battery":{"capacity":self.C_p_bat[4],"efficiency":self.eta_bat[4],"capacity_loss_coefficient":self.C_f_bat,"loss_coefficient":0,"nominal_power":self.E_bat_max[4],"power_efficiency_curve":[[0,1],[1,1]],"capacity_power_curve":[[0,1],[1,1]]}
              },
         
         "Building_6":{"Heat_Pump":{"nominal_power": self.E_hpC_max[5], "technical_efficiency":self.eta_hp_tech, "t_target_heating":45 ,"t_target_cooling":self.t_hp_C},
               "Electric_Water_Heater":{"nominal_power":self.E_ehH_max[5], "efficiency":self.eta_ehH},
               "Chilled_Water_Tank":{"capacity":self.C_p_Csto[5], "loss_coefficient":self.C_f_Csto},
               "DHW_Tank":{"capacity":self.C_p_Hsto[5], "loss_coefficient":self.C_f_Csto},
			   "Battery":{"capacity":self.C_p_bat[5],"efficiency":self.eta_bat[5],"capacity_loss_coefficient":self.C_f_bat,"loss_coefficient":0,"nominal_power":self.E_bat_max[5],"power_efficiency_curve":[[0,1],[1,1]],"capacity_power_curve":[[0,1],[1,1]]}
              },
         
         "Building_7":{"Heat_Pump":{"nominal_power": self.E_hpC_max[6], "technical_efficiency":self.eta_hp_tech, "t_target_heating":45 ,"t_target_cooling":self.t_hp_C},
               "Electric_Water_Heater":{"nominal_power":self.E_ehH_max[6], "efficiency":self.eta_ehH},
               "Chilled_Water_Tank":{"capacity":self.C_p_Csto[6], "loss_coefficient":self.C_f_Csto},
               "DHW_Tank":{"capacity":self.C_p_Hsto[6], "loss_coefficient":self.C_f_Csto},
			   "Battery":{"capacity":self.C_p_bat[6],"efficiency":self.eta_bat[6],"capacity_loss_coefficient":self.C_f_bat,"loss_coefficient":0,"nominal_power":self.E_bat_max[6],"power_efficiency_curve":[[0,1],[1,1]],"capacity_power_curve":[[0,1],[1,1]]}
              },
         
         "Building_8":{"Heat_Pump":{"nominal_power": self.E_hpC_max[7], "technical_efficiency":self.eta_hp_tech, "t_target_heating":45 ,"t_target_cooling":self.t_hp_C},
               "Electric_Water_Heater":{"nominal_power":self.E_ehH_max[7], "efficiency":self.eta_ehH},
               "Chilled_Water_Tank":{"capacity":self.C_p_Csto[7], "loss_coefficient":self.C_f_Csto},
               "DHW_Tank":{"capacity":self.C_p_Hsto[7], "loss_coefficient":self.C_f_Csto},
			   "Battery":{"capacity":self.C_p_bat[7],"efficiency":self.eta_bat[7],"capacity_loss_coefficient":self.C_f_bat,"loss_coefficient":0,"nominal_power":self.E_bat_max[7],"power_efficiency_curve":[[0,1],[1,1]],"capacity_power_curve":[[0,1],[1,1]]}
              },
         
         "Building_9":{"Heat_Pump":{"nominal_power": self.E_hpC_max[8], "technical_efficiency":self.eta_hp_tech, "t_target_heating":45 ,"t_target_cooling":self.t_hp_C},
               "Electric_Water_Heater":{"nominal_power":self.E_ehH_max[8], "efficiency":self.eta_ehH},
               "Chilled_Water_Tank":{"capacity":self.C_p_Csto[8], "loss_coefficient":self.C_f_Csto},
               "DHW_Tank":{"capacity":self.C_p_Hsto[8], "loss_coefficient":self.C_f_Csto},
			   "Battery":{"capacity":self.C_p_bat[8],"efficiency":self.eta_bat[8],"capacity_loss_coefficient":self.C_f_bat,"loss_coefficient":0,"nominal_power":self.E_bat_max[8],"power_efficiency_curve":[[0,1],[1,1]],"capacity_power_curve":[[0,1],[1,1]]}
              }
        }
        ...
        for uid, attributes  in zip(data_dict, data_dict.values()):
            ...
            chilled_water_tank = EnergyStorage(capacity = attributes['Chilled_Water_Tank']['capacity'],
                                               loss_coef = attributes['Chilled_Water_Tank']['loss_coefficient'], save_memory = self.save_memory)

            dhw_tank = EnergyStorage(capacity = attributes['DHW_Tank']['capacity'],
                                     loss_coef = attributes['DHW_Tank']['loss_coefficient'], save_memory = self.save_memory)

            building = Building(buildingId = uid, dhw_storage = dhw_tank, cooling_storage = chilled_water_tank, electrical_storage = battery, dhw_heating_device = electric_heater, cooling_device = heat_pump, save_memory = self.save_memory)
...
#         self.eta_bat = memory['eta_bat'][total_it % 24,:]
...
#         self.H_max = memory['H_max'][total_it % 24,:]
    ...
    def transition(self, states, actions, total_it):
        ...
        dict_build = {'Building_1': 0, 'Building_2': 1, 'Building_3': 2, 'Building_4': 3, 'Building_5': 4, 'Building_6': 5, 'Building_7': 6, 'Building_8': 7, 'Building_9': 8, }
        ...
        for a, (uid, building) in zip(actions, self.buildings.items()):
            ...
            if self.buildings_states_actions[uid]['actions']['electrical_storage']:
                ...
                if self.buildings_states_actions[uid]['actions']['cooling_storage']:
                    ...
                    # Cooling
                    _electric_demand_cooling = building.set_storage_cooling(a[0], self.C_p_Csto[dict_build[uid]],self.SOC_Csto[dict_build[uid]], self.C_bd[dict_build[uid]], self.COP_C[dict_build[uid]], self.E_bat_max[dict_build[uid]], self.SOC_Csto[dict_build[uid]])
                    ...
                    if self.buildings_states_actions[uid]['actions']['dhw_storage']:
                        ...
                        # DHW
                        _electric_demand_dhw = building.set_storage_heating(a[1], self.E_ehH_max[dict_build[uid]], self.C_p_Hsto[dict_build[uid]], self.SOC_Hsto[dict_build[uid]], self.H_bd[dict_build[uid]], self.SOC_Hsto[dict_build[uid]])
                        elec_consumption_dhw_storage += building._electric_consumption_dhw_storage

                        # Electrical
                        _electric_demand_electrical_storage = building.set_storage_electrical(a[2], self.C_p_bat[dict_build[uid]], self.SOC_bat[dict_build[uid]])
                        elec_consumption_electrical_storage += _electric_demand_electrical_storage

                            # 'Electrical Storage' & 'Cooling Storage'
                    else:
                        _electric_demand_dhw = building.set_storage_heating(0.0, self.E_ehH_max[dict_build[uid]], self.C_p_Hsto[dict_build[uid]], self.SOC_Hsto[dict_build[uid]], self.H_bd[dict_build[uid]])
                        # Electrical
                        _electric_demand_electrical_storage = building.set_storage_electrical(a[1], self.C_p_bat[dict_build[uid]], self.SOC_bat[dict_build[uid]])
                        elec_consumption_electrical_storage += _electric_demand_electrical_storage
                else:
                    ...
                    if self.buildings_states_actions[uid]['actions']['dhw_storage']:
                        # DHW
                        _electric_demand_dhw = building.set_storage_heating(a[0], self.E_ehH_max[dict_build[uid]], self.C_p_Hsto[dict_build[uid]], self.SOC_Hsto[dict_build[uid]], self.H_bd[dict_build[uid]])
                        elec_consumption_dhw_storage += building._electric_consumption_dhw_storage
                    ...
                    # 'Electrical Storage'
                        ...
                        # Electrical
                        _electric_demand_electrical_storage = building.set_storage_electrical(a[0], self.C_p_bat[dict_build[uid]], self.SOC_bat[dict_build[uid]])
                        elec_consumption_electrical_storage += _electric_demand_electrical_storage
                ...
                if self.buildings_states_actions[uid]['actions']['cooling_storage']:
                    # Cooling
                    _electric_demand_cooling = building.set_storage_cooling(a[0], self.C_p_Csto[dict_build[uid]], self.C_bd[dict_build[uid]])
                    elec_consumption_cooling_storage += sbuilding._electric_consumption_cooling_storage

                    if self.buildings_states_actions[uid]['actions']['dhw_storage']:
                        # DHW
                        _electric_demand_dhw = building.set_storage_heating(a[1], self.E_ehH_max[dict_build[uid]], self.C_p_Hsto[dict_build[uid]], self.SOC_Hsto[dict_build[uid]], self.H_bd[dict_build[uid]])
                        elec_consumption_dhw_storage += building._electric_consumption_dhw_storage
                    ...
                    _electric_demand_cooling = building.set_storage_cooling(0.0, self.C_p_Csto[dict_build[uid]], self.C_bd[dict_build[uid]])
                    # DHW
                    _electric_demand_dhw = building.set_storage_heating(a[0], self.E_ehH_max[dict_build[uid]], self.C_p_Hsto[dict_build[uid]], self.SOC_Hsto[dict_build[uid]], self.H_bd[dict_build[uid]])
                    elec_consumption_dhw_storage += building._electric_consumption_dhw_storage
        ...
        building_electric_demand = np.round((_electric_demand_electrical_storage + _electric_demand_cooling + _electric_demand_dhw + _non_shiftable_load - _solar_generation).astype(np.float32), 4)
...
#         self.carbon_emissions.append(np.float32(max(0, electric_demand)*self.current_carbon_intensity))
        ...
        transition_digital_twin = self._get_ob()  # self._get_ob() returns the next states
