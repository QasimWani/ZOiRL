...
class Actor:
    def __init__(
        ...
        self.prob = [[None] * 24] * 9  # template for each hour, per building  (9x24)
    ...
    def create_problem(self, t: int, parameters: dict, building_id: int):
        ...
        # Battery
        C_p_bat = np.mean(parameters["C_p_bat"][t, building_id])
        ...
        C_p_Hsto = np.mean(parameters["C_p_Hsto"][:, building_id])
        ...
        C_p_Csto = np.mean(parameters["C_p_Csto"][:, building_id])
